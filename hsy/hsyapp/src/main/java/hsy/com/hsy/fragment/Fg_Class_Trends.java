...
public class Fg_Class_Trends extends BaseFragment {
    ...
    protected void initParams(View view, Bundle savedInstanceState) {
        ...
        initData();
        HomeListAdapter homeListAdapter = new HomeListAdapter(item_name, item_time, item_content, true,user_icon,true, null, commit_content, getContext());
    ...
    private void initData() {
        ...
        user_icon = new ArrayList<>();
        user_icon.add("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=2031677745,545048845&fm=58&bpow=400&bpoh=400");
        user_icon.add("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=2031677745,545048845&fm=58&bpow=400&bpoh=400");
        user_icon.add("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=2031677745,545048845&fm=58&bpow=400&bpoh=400");
        user_icon.add("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=2031677745,545048845&fm=58&bpow=400&bpoh=400");
        user_icon.add("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=2031677745,545048845&fm=58&bpow=400&bpoh=400");
